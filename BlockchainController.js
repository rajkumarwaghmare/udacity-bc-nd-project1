...
class BlockchainController {
  ...
  /**
   * This endpoint allows you to validate the blockchain in its current state.
   * validateChain will scan each block sequentially and for huge BC this operation will take lots of time and computing power
   * So this end point should be access restricted (fine for an assignment)
   *  */
  validateBlockchain() {
